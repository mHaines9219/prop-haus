  ...
  return (
    <div className="group flex flex-col bg-background">
      ...
      <div className="flex flex-1 flex-col p-5">
        <p className="font-display text-[18px] font-bold leading-[24px] [font-stretch:125%]">
          {contractor.name}
        </p>
        ...
        <div className="mt-2 flex flex-wrap gap-1.5">
          {contractor.skills.map((s) => (
            <span
              key={s}
              className="rounded-sm border border-border px-1.5 py-0.5 font-mono text-[11px] uppercase leading-none tracking-[0.06em] text-text-tertiary"
            >
              {SKILL_LABELS[s] ?? s}
            </span>
          ))}
          ...
          {status === 'sent' ? (
            ...
            <>
              <button
                ...
                className={cn(
                  'h-9 rounded-sm border px-4 font-mono text-[12px] font-medium uppercase tracking-[0.06em] transition-colors duration-150',
                  formOpen
                    ...
                    <div className="flex flex-col gap-3 pt-4">
                      <label className="flex flex-col gap-1">
                        ...
                        <input
                          ...
                          className="h-9 w-full rounded-sm border border-border bg-surface-inset px-3 font-mono text-[13px] text-foreground placeholder:text-text-disabled focus:border-ring focus:outline-none focus:ring-1 focus:ring-ring/50"
                        />
                      </label>
                      ...
                      <label className="flex flex-col gap-1">
                        ...
                        <Textarea
                          ...
                          rows={3}
                          className="resize-none rounded-sm border-border bg-surface-inset font-mono text-[13px] text-foreground placeholder:text-text-disabled focus:border-ring focus:ring-ring/50"
                        />
                      </label>
                      ...
                      <button
                        ...
                        className="h-9 rounded-sm bg-primary px-4 font-mono text-[12px] font-medium uppercase tracking-[0.06em] text-primary-foreground transition-opacity hover:opacity-90 disabled:opacity-50"
                      >
