        ...
        {sent ? (
          ...
          <div className="mt-8 space-y-4">
            <button
              ...
              className="flex h-11 w-full items-center justify-center gap-2 rounded-md border border-accent text-sm font-medium text-accent-text transition-colors duration-150 hover:bg-accent/15 active:scale-[0.98] disabled:opacity-60"
            >
            ...
            <form onSubmit={submit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="h-11 w-full rounded-md border border-border bg-surface-inset px-4 font-mono text-[15px] text-foreground outline-none placeholder:text-text-tertiary focus:border-border-strong"
                />
                {error && (
              ...
              <button
                ...
                className="flex h-11 w-full items-center justify-center rounded-md border border-border text-sm font-medium text-text-secondary transition-colors duration-150 hover:border-border-strong hover:text-foreground active:scale-[0.98] disabled:opacity-60"
              >
