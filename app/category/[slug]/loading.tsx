  ...
  return (
    <PageShell>
      <div className="mx-auto w-full max-w-[1600px] px-4 py-8 sm:px-6 sm:py-10">
        <div className="h-5 w-24 animate-pulse rounded-md bg-surface-inset" />
        <div className="mt-6 space-y-2">
          <div className="h-3.5 w-16 animate-pulse rounded-md bg-surface-inset" />
          <div className="h-8 w-48 animate-pulse rounded-md bg-surface-inset" />
          <div className="h-4 w-28 animate-pulse rounded-md bg-surface-inset" />
        </div>
        <div className="mt-8">
          <SeamGrid>
